...
/********************************************************************************************/
/*																							*/
/* Procédure permettant de créer une solution du Job-Shop à partir d'un vecteur de Birwirth */
/*																							*/
...
/********************************************************************************************/
/*																							*/
/*   Procédure permettant d'optimiser une solution obtenue à partir du vecteur de Birwirth  */
/*																							*/
/* Entrée:				-sol						Variable contenant les données de la	*/
/*													solution obtenue						*/
/*						-instance:					Variable contenant les données			*/
...
/********************************************************************************************/
/*																							*/
/*					Procédure permettant d'afficher le vecteur de Birwirth					*/
/*																							*/
/* Entrée:				-sol						Variable contenant les données de la	*/
/*													solution obtenue						*/
/*						-instance:					Variable contenant les données			*/
...
/*				dans le vecteur de Birwirth pour faire la permutation des sommets			*/
/*																							*/
/* Entrée:				-sol						Variable contenant les données de la	*/
/*													solution obtenue						*/
/*						-instance:					Variable contenant les données			*/
 ...
 * @param instance variable stockant les données du Job Shop à traiter
 * @param s variable stockant les données du graphe généré à partir du Job Shop dont le vecteur de Bierwirth
 * @return T_solution voisin d'une solution
 */
 ...
 *
 * @param[in] instance variable stockant les données du Job Shop à traiter
...
void GRASP(T_instance instance, T_solution& sol) {
	...
	for (int i = 0; i < 1000; i++) {
		...
		while (numero_voisin != 5 && compteur < 10) {
			T_solution solution_nouv = generer_voisin(instance, sol);
			init_solution(solution_nouv, instance);
			evaluer(solution_nouv, instance);
			recherche_locale(solution_nouv, instance);

			if (tester_double(instance, solution_nouv, hash)) {
